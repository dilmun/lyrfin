...
- [ ] **Terminal compatibility.** Developed on [**Ghostty**](https://ghostty.org);
  **iTerm2** and **WezTerm** (macOS) now verified too, including inline album art — it advertises
  ...
  (Kitty/sixel/iTerm2), Unicode / RTL shaping, mouse — on Kitty, Alacritty, foot,
  and Windows Terminal, and document what's supported per
